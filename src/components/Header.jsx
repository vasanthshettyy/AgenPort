        ...
        <div className="max-w-[1400px] w-full mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="hidden sm:block group relative">
              ...
              >
                <span className="relative z-10 group-hover:text-canvas transition-colors duration-150 ease-out group-hover:duration-[300ms] group-hover:ease-in">CONTACT</span>
      ...
      {mobileMenuOpen && (
        ...
        >
          ...
          <nav className="flex flex-col gap-6 sm:gap-8 text-center">
            ...
            >
              <span className="relative z-10 group-hover:text-content-accent transition-colors duration-150 ease-out group-hover:duration-[300ms] group-hover:ease-in">Get in Touch</span>
              <div className="absolute inset-0 bg-canvas translate-y-full group-hover:translate-y-0 transition-[transform,opacity] duration-150 ease-out group-hover:duration-[300ms] group-hover:ease-in" />
            </a>
          </nav>
        </div>
      )}
