      ...
      <section className="min-h-screen flex items-center justify-center bg-canvas p-6">
        <div className="max-w-md w-full text-center">
          ...
          <a href="/" className="group relative inline-flex items-center gap-2 px-6 py-3 rounded-xl text-canvas font-bold bg-accent-primary overflow-hidden">
            <span className="relative z-10 group-hover:text-accent-primary transition-colors duration-150 ease-out group-hover:duration-[300ms] group-hover:ease-in">Return to Core Infrastructure</span>
            <div className="absolute inset-0 bg-white translate-y-full group-hover:translate-y-0 transition-[transform,opacity] duration-150 ease-out group-hover:duration-[300ms] group-hover:ease-in" />
          </a>
        </div>
      </section>
    </>
