export const countryMarkets = [
  ...
  { code: 'IE', label: 'Ireland / EU', currency: 'EUR', symbol: '€' },
...
export const pricingPlans = [
  {
    ...
    pricing: {
      ...
      IE: { amount: 625, display: '€625' },
      IN: { amount: 10000, display: '₹10,000' }
    },
    retainer: {
      name: 'Starter Care',
      ...
      pricing: {
        ...
        IE: { amount: 100, display: '€100/mo' },
        IN: { amount: 1500, display: '₹1,500/mo' }
      }
    }
  },
  {
    ...
    pricing: {
      ...
      IE: { amount: 1950, display: '€1,950' },
      IN: { amount: 28000, display: '₹28,000' }
    },
    retainer: {
      name: 'Standard Care',
      ...
      pricing: {
        ...
        IE: { amount: 220, display: '€220/mo' },
        IN: { amount: 3500, display: '₹3,500/mo' }
      }
    }
  },
  {
    ...
    pricing: {
      ...
      IE: { amount: 3600, display: '€3,600' },
      IN: { amount: 55000, display: '₹55,000' }
    },
    retainer: {
      name: 'Growth Care',
      ...
      pricing: {
        ...
        IE: { amount: 480, display: '€480/mo' },
        IN: { amount: 7500, display: '₹7,500/mo' }
      }
    }
  }
];
