export const techStack = [
  ...
  { name: "MongoDB", category: "Database", description: "Flexible NoSQL database for unstructured data." },
  { name: "Vercel", category: "DevOps", description: "Edge network deployment and serverless functions." },
  { name: "Stripe", category: "Integrations", description: "Payment processing infrastructure." },
];
